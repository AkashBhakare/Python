# -*- coding: utf-8 -*-
"""
Created on Tue Jan 18 18:17:06 2022
...
#       Formatted text display. Allows you to display and 
#       edit text with various styles and attributes. 
...
# We can query whether or not the box has been checked by attaching a tkinter variable to it (StringVar, IntVar etc)  with variable=self.my_variable. By deault the value of this  variable will be 1 when checked and 0 when not. We can change this with the onvalue and offvalue arguments. Changing the linked variable directly will update the associated Checkbutton automatically
