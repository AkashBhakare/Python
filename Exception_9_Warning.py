# -*- coding: utf-8 -*-
"""
Created on Fri Dec 10 16:50:47 2021
...
def adder(limit):
    ...
    if limit > 1000:
        warnings.simplefilter("default") ##ignore/default/error
...
if __name__ == '__main__':
    # print("Adding : ", adder(2000))
    # data = [10,20,30,40,50,60]
    # print("The Value is : ",getElementFromCollection(data,1))
